...
const ExploreAthletes = () => {
    return (
        <>
            ...
            <section className="py-8 bg-black px-4 sm:px-6">
                <h1 className="text-3xl sm:text-4xl lg:text-[5rem] text-center capitalize font-medium bg-[linear-gradient(to_right,#d4bc6d,#57430d)] bg-clip-text text-transparent mb-8">
                    Trending Athletes
                </h1>
